...
from gemma4_core.runtime import configure_root_logging, configure_unsloth_compile_cache, resolve_notebook_dir
...
try:
    from distributed_training.adapter_utils import normalize_saved_adapter_config
except ImportError:
    from adapter_utils import normalize_saved_adapter_config
